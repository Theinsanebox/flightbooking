...
(6, 'hey There', '2022-01-23 23:06:38', '2022-01-23 23:06:38'),
(7, 'Hey Ankur', '2022-01-24 00:40:24', '2022-01-24 00:40:24'),
(8, 'hey There', '2022-01-24 00:40:37', '2022-01-24 00:40:37');
...
--
-- Table structure for table `migratable`
--

CREATE TABLE `migratable` (
  `id` bigint(20) UNSIGNED NOT NULL,
...
(7, '2022_01_22_122749_create_migratable_table', 2),
(8, '2022_01_24_035247_create_chats_table', 3);
...
INSERT INTO `usertables` (`id`, `name`, `agencyname`, `loginid`, `email`, `password`, `alternateemail`, `mobile`, `phone`, `gstno`, `panno`, `city`, `state`, `pincode`, `referredby`, `status`, `created_at`, `updated_at`) VALUES
(38, 'jainil', 'bg', 'jainil@123', 'jainilsoni1703@gmail.com', 'jainil@123', 'jainilsoni88940@gmail.com', 1234567890, 281121212, 'JR123', '123JR', 'Rajkot', 'Gujarat', 360002, 'REF123', 1, '2022-01-26 06:18:10', '2022-01-28 08:27:35');
...
--
-- Indexes for table `migratable`
--
ALTER TABLE `migratable`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `migratable`
--
ALTER TABLE `migratable`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
